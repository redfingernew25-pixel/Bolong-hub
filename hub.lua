--[[
    ...
    Features: Speed, Fly, ESP (Box, Name, Health, Line, Distance), Team Check
    Loader: loadstring(game:HttpGet("https://raw.githubusercontent.com/RillBoys/BOLONG-HUB/refs/heads/main/main/BOLONGHUB"))()
]]
...
-- ANTI-DUPLICATE
--==============================================================
if CoreGui:FindFirstChild("BolongHubUI") then
    CoreGui.BolongHubUI:Destroy()
end
